...
export default function InputData(props: Props) {
    ...
    return (
        <div className=" relative flex-1 flex items-center">
            ...
            <input type={props.type !== undefined ? props.type : "text"} name="" id="" className="md:h-12 h-11 peer bg-cinza-escuro my-3 outline-0 indent-1 rounded-[3px] text-white border-l-2 border border-l-amarelo-claro border-[#ffffff36] p-1.5 w-full " placeholder={props.placeholder} onChange={(evt) => { manageDataInput(evt.target.value) }} />
